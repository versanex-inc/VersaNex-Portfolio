...
const Gfx_design_illustrations = () => {
    ...
    async function fetchData() {
      try {
        ...
        const filteredProjects = data.result.filter(
          (project) => project.subCategory === "illustration"
        );
          ...
          {projects.map((item) => (
            ...
            >
              ...
              <div className="content_detail">
                <Link href={`/projects/${item.slug}`} className="content_title">
                  <p>{item.title}</p>
                </Link>
...
export default Gfx_design_illustrations;
